...
type ComplexityRoot struct {
	...
	Mutation struct {
		...
		DeleteBooksByAuthor func(childComplexity int, id string) int
	}

	Query struct {
		AllAuthors    func(childComplexity int) int
		AllBooks      func(childComplexity int) int
		BooksByAuthor func(childComplexity int, id string) int
	}
}
...
type MutationResolver interface {
	...
	DeleteBooksByAuthor(ctx context.Context, id string) ([]model.Book, error)
}
type QueryResolver interface {
	AllBooks(ctx context.Context) ([]model.Book, error)
	AllAuthors(ctx context.Context) ([]model.Author, error)
	BooksByAuthor(ctx context.Context, id string) ([]model.Book, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.deleteBooksByAuthor":
		if e.complexity.Mutation.DeleteBooksByAuthor == nil {
			break
		}

		args, err := ec.field_Mutation_deleteBooksByAuthor_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Mutation.DeleteBooksByAuthor(childComplexity, args["id"].(string)), true
	...
	case "Query.booksByAuthor":
		...
		return e.complexity.Query.BooksByAuthor(childComplexity, args["id"].(string)), true
...
var sources = []*ast.Source{
	&ast.Source{Name: "internal/schema/schema.gql", Input: `"Represents Book Categories"
enum BookCategory {
  ROMANCE
  DRAMA
  FICTION
...
func (ec *executionContext) field_Mutation_deleteBooksByAuthor_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 string
	if tmp, ok := rawArgs["id"]; ok {
...
func (ec *executionContext) _Author_first(ctx context.Context, field graphql.CollectedField, obj *model.Author) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Author_last(ctx context.Context, field graphql.CollectedField, obj *model.Author) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Mutation_deleteBooksByAuthor(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	rawArgs := field.ArgumentMap(ec.Variables)
	args, err := ec.field_Mutation_deleteBooksByAuthor_args(ctx, rawArgs)
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	}
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().DeleteBooksByAuthor(rctx, args["id"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Query_booksByAuthor(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	rawArgs := field.ArgumentMap(ec.Variables)
	args, err := ec.field_Query_booksByAuthor_args(ctx, rawArgs)
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	}
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().BooksByAuthor(rctx, args["id"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation(ctx context.Context, sel ast.SelectionSet) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "deleteBooksByAuthor":
			out.Values[i] = ec._Mutation_deleteBooksByAuthor(ctx, field)
		default:
			panic("unknown field " + strconv.Quote(field.Name))
		}
	}
